...
<body class="home">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/1.jpeg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Enjoy your Food</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            <div class="col-xs-12 col-sm-5 right-image text-center">
                                <figure> <img src="images/phone.png" alt="Right Image" class="img-fluid"> </figure>
                            </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <h5>Phone: <a href="+919531645498">+91 9531645498</a></h5> </div>

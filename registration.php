                     ...
                     <div class="col-md-4">
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>Can users easily contact customer support if they encounter registration issues?</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq1" aria-expanded="false" role="article" style="height: 0px;">
                              <div class="panel-body"> Absolutely, users can reach out to customer support through various channels, such as phone, email, or live chat, for assistance with any registration-related problems. Additionally, offer a detailed FAQ section for common questions and issues. </div>
                           </div>
                        </div>
                        <!-- end:panel -->
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>Can users add and manage multiple delivery addresses, like home and work locations, in their account?</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq2" aria-expanded="true" role="article">
                              <div class="panel-body"> Absolutely, users can add, edit, and delete multiple delivery addresses to make ordering more convenient. Offer a user-friendly interface to manage these addresses. </div>
                           </div>
                        </div>
                        <!-- end:Panel -->
                     ...
                     <div class="row text-img-block text-xs-left">
                        <div class="container">
                           <div class="col-xs-12 col-sm-6  right-image text-center">
                              <figure> <img src="images/phone.png" alt="Right Image"> </figure>
                           </div>
                     ...
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-4 address color-gray">
                              ...
                              <h5>Phone: <a href="tel:+919531645498">+91 9531645498</a></h5>
                           </div>
